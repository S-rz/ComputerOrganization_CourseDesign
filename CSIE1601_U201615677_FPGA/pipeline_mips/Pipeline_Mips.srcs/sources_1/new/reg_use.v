module reg_use(
    ...
    assign R1_Used=ADD|ADDU|SUB|AND|OR|NOR|SLT|SLTU|JR|SYSCALL|BEQ|BNE|ADDI|ANDI|ADDIU|SLTI|ORI|LW|SW|SRLV|SRAV|LH|BLEZ;
    assign R2_Used=SLL|SRA|SRL|ADD|ADDU|SUB|AND|OR|NOR|SLT|SLTU|SYSCALL|BEQ|BNE|SW|SRLV|SRAV|BLEZ;
endmodule
