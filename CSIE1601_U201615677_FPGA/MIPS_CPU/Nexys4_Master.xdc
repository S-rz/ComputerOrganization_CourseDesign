...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets powerbutton_IBUF]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets change_IBUF]
## Switches
#Bank = 34, Pin name = IO_L21P_T3_DQS_34,					Sch name = SW0
set_property PACKAGE_PIN U9 [get_ports {powerbutton}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {powerbutton}]
#Bank = 34, Pin name = IO_25_34,							Sch name = SW1
set_property PACKAGE_PIN U8 [get_ports {reset}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {reset}]
#Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
set_property PACKAGE_PIN R7 [get_ports {change}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {change}]
##Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = SW3
#set_property PACKAGE_PIN R6 [get_ports {opendoor}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {opendoor}]
...
#set_property PACKAGE_PIN V6 [get_ports {in_button1}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {in_button1}]
##Bank = 34, Pin name = IO_L10P_T1_34,						Sch name = SW7
#set_property PACKAGE_PIN V5 [get_ports {in_button3}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {in_button3}]
##Bank = 34, Pin name = IO_L8P_T1-34,						Sch name = SW8
#set_property PACKAGE_PIN U4 [get_ports {in_button6}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {in_button6}]
##Bank = 34, Pin name = IO_L9N_T1_DQS_34,					Sch name = SW9
#set_property PACKAGE_PIN V2 [get_ports {in_button8}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {in_button8}]
##Bank = 34, Pin name = IO_L9P_T1_DQS_34,					Sch name = SW10
#set_property PACKAGE_PIN U2 [get_ports {out_button1}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {out_button1}]
##Bank = 34, Pin name = IO_L11N_T1_MRCC_34,					Sch name = SW11
#set_property PACKAGE_PIN T3 [get_ports {out_downbutton3}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {out_downbutton3}]
##Bank = 34, Pin name = IO_L17N_T2_34,						Sch name = SW12
#set_property PACKAGE_PIN T1 [get_ports {out_upbutton3}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {out_upbutton3}]
##Bank = 34, Pin name = IO_L11P_T1_SRCC_34,					Sch name = SW13
#set_property PACKAGE_PIN R3 [get_ports {out_downbutton6}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {out_downbutton6}]
##Bank = 34, Pin name = IO_L14N_T2_SRCC_34,					Sch name = SW14
#set_property PACKAGE_PIN P3 [get_ports {out_upbutton6}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {out_upbutton6}]
##Bank = 34, Pin name = IO_L14P_T2_SRCC_34,					Sch name = SW15
#set_property PACKAGE_PIN P4 [get_ports {out_button8}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {out_button8}]
 


## LEDs
##Bank = 34, Pin name = IO_L24N_T3_34,						Sch name = LED0
#set_property PACKAGE_PIN T8 [get_ports {powerlight}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {powerlight}]
##Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
##set_property PACKAGE_PIN V9 [get_ports {led[1]}]					
##	set_property IOSTANDARD LVCMOS33 [get_ports {led[1]}]
##Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
#set_property PACKAGE_PIN R8 [get_ports {close_light}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {close_light}]
##Bank = 34, Pin name = IO_L23N_T3_34,						Sch name = LED3
#set_property PACKAGE_PIN T6 [get_ports {open_light}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {open_light}]
##Bank = 34, Pin name = IO_L12P_T1_MRCC_34,					Sch name = LED4
#set_property PACKAGE_PIN T5 [get_ports {down_light}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {down_light}]
##Bank = 34, Pin name = IO_L12N_T1_MRCC_34,					Sch	name = LED5
#set_property PACKAGE_PIN T4 [get_ports {up_light}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {up_light}]
##Bank = 34, Pin name = IO_L22P_T3_34,						Sch name = LED6
#set_property PACKAGE_PIN U7 [get_ports {light1}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {light1}]
##Bank = 34, Pin name = IO_L22N_T3_34,						Sch name = LED7
#set_property PACKAGE_PIN U6 [get_ports {light4}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {light4}]
##Bank = 34, Pin name = IO_L10N_T1_34,						Sch name = LED8
#set_property PACKAGE_PIN V4 [get_ports {light7}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {light7}]
##Bank = 34, Pin name = IO_L8N_T1_34,						Sch name = LED9
#set_property PACKAGE_PIN U3 [get_ports {light8}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {light8}]
##Bank = 34, Pin name = IO_L7N_T1_34,						Sch name = LED10
#set_property PACKAGE_PIN V1 [get_ports {out1}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {out1}]
##Bank = 34, Pin name = IO_L17P_T2_34,						Sch name = LED11
#set_property PACKAGE_PIN R1 [get_ports {down4}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {down4}]
##Bank = 34, Pin name = IO_L13N_T2_MRCC_34,					Sch name = LED12
#set_property PACKAGE_PIN P5 [get_ports {up4}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {up4}]
##Bank = 34, Pin name = IO_L7P_T1_34,						Sch name = LED13
#set_property PACKAGE_PIN U1 [get_ports {down7}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {down7}]
##Bank = 34, Pin name = IO_L15N_T2_DQS_34,					Sch name = LED14
#set_property PACKAGE_PIN R2 [get_ports {k[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {k[0]}]
##Bank = 34, Pin name = IO_L15P_T2_DQS_34,					Sch name = LED15
#set_property PACKAGE_PIN P2 [get_ports {k[1]}]					
...
set_property PACKAGE_PIN L3 [get_ports {eight_led[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {eight_led[7]}]
#Bank = 34, Pin name = IO_L3N_T0_DQS_34,					Sch name = CB
set_property PACKAGE_PIN N1 [get_ports {eight_led[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {eight_led[6]}]
#Bank = 34, Pin name = IO_L6N_T0_VREF_34,					Sch name = CC
set_property PACKAGE_PIN L5 [get_ports {eight_led[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {eight_led[5]}]
#Bank = 34, Pin name = IO_L5N_T0_34,						Sch name = CD
set_property PACKAGE_PIN L4 [get_ports {eight_led[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {eight_led[4]}]
#Bank = 34, Pin name = IO_L2P_T0_34,						Sch name = CE
set_property PACKAGE_PIN K3 [get_ports {eight_led[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {eight_led[3]}]
#Bank = 34, Pin name = IO_L4N_T0_34,						Sch name = CF
set_property PACKAGE_PIN M2 [get_ports {eight_led[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {eight_led[2]}]
#Bank = 34, Pin name = IO_L6P_T0_34,						Sch name = CG
set_property PACKAGE_PIN L6 [get_ports {eight_led[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {eight_led[1]}]

#Bank = 34, Pin name = IO_L16P_T2_34,						Sch name = DP
set_property PACKAGE_PIN M4 [get_ports {eight_led[0]}]							
	set_property IOSTANDARD LVCMOS33 [get_ports {eight_led[0]}]

#Bank = 34, Pin name = IO_L18N_T2_34,						Sch name = AN0
set_property PACKAGE_PIN N6 [get_ports {led_A}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {led_A}]
#Bank = 34, Pin name = IO_L18P_T2_34,						Sch name = AN1
set_property PACKAGE_PIN M6 [get_ports {led_B}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {led_B}]
#Bank = 34, Pin name = IO_L4P_T0_34,						Sch name = AN2
set_property PACKAGE_PIN M3 [get_ports {led_C}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {led_C}]
#Bank = 34, Pin name = IO_L13_T2_MRCC_34,					Sch name = AN3
set_property PACKAGE_PIN N5 [get_ports {led_D}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {led_D}]
#Bank = 34, Pin name = IO_L3P_T0_DQS_34,					Sch name = AN4
set_property PACKAGE_PIN N2 [get_ports {led_E}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {led_E}]
#Bank = 34, Pin name = IO_L16N_T2_34,						Sch name = AN5
set_property PACKAGE_PIN N4 [get_ports {led_F}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {led_F}]
#Bank = 34, Pin name = IO_L1P_T0_34,						Sch name = AN6
set_property PACKAGE_PIN L1 [get_ports {led_G}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {led_G}]
#Bank = 34, Pin name = IO_L1N_T034,							Sch name = AN7
set_property PACKAGE_PIN M1 [get_ports {led_H}]					
