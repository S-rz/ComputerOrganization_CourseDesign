...
HD_PWD='D:/vivado_test/MIPS_CPU/MIPS_CPU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MipsCPU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MipsCPU.tcl -notrace
